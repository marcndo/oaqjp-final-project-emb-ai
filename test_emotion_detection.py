...
"""Test file for emotion detection function
"""
import unittest
from EmotionDetection.emotion_detection import emotion_detector

class TestEmotionDetector(unittest.TestCase):
    """Test class for emtion detection function
    """
    def test_emotion_detection(self):
        """ compares the actual outcome with the resulted outcome from the emotion
        detection function
        """
